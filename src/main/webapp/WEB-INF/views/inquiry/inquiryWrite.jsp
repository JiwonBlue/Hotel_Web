...
<body>
   ...
   <div id="detailcomment">
      ...
      <tr>
         <td id="detail" >작성자</td>
         <td><input type="text" name="b_title" maxlength="30" id="writeTitle" value="${member.memberId}" readonly/></td>
   
      </tr>
         
         <tr>
            <td id="detail" >TITLE</td>
            <td><input type="text" name="b_title" maxlength="30" id="writeTitle" placeholder="내용을 상세히 기재해 주시면 운영에 많은 도움이 됩니다"/></td>
         </tr>
         <tr>
...
>>>>>>> 312ae102ff7e2400180f94cdaf3670474ac6570b
</body>
</html>