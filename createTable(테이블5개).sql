...
CREATE TABLE ROOM_TABLE(
	ROOM_CODE NUMBER(20) NOT NULL constraint ROOM_CODE_PK primary key, --객실코드(PK)
...
CREATE TABLE RESERVE_TABLE(
	RESERVE_CODE NUMBER(20) NOT NULL constraint RESERVE_CODE_PK primary key, --예약code(PK)
	MEMBER_ID VARCHAR2(30) NOT NULL constraint RESERVE_MEMBER_ID_FK references MEMBER_TABLE(MEMBER_ID), --회원정보code(FK)
	ROOM_CODE NUMBER(20) NOT NULL constraint RESERVE_ROOM_CODE_FK references ROOM_TABLE(ROOM_CODE), --객실code(FK)
...
CREATE TABLE BOARD_TABLE(
	BOARD_CODE NUMBER(20) NOT NULL constraint BOARD_CODE_PK primary key, --게시판코드(PK)
...
CREATE TABLE PAY_TABLE(
	PAY_CODE NUMBER(20) NOT NULL constraint PAY_CODE primary key, --결제code(PK)
	RESERVE_CODE NUMBER(20) NOT NULL constraint PAY_RESERVE_CODE_FK references RESERVE_TABLE(RESERVE_CODE), --예약code(FK)
