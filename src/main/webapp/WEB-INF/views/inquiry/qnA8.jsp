	  ...
	  <div class="centered-text">
		...
		<table align="center" class="inquiryDetail">
			<tr>
				...
				<td align="center" style="font-size: 22px; max-width: 30px;">환불은 언제 받을 수 있나요?</td>
			</tr>
			<tr>
				<td id="detail">CONTENT</td>
				<td align="center" rows="5" cols="40" style="font-size: 18px; max-width: 30px;">
					선불 예약을 위해 약 30영업일이 경과한 후 이용 대금이 청구된 귀하의 신용카드 계정으로 환급금이 도로 입금됩니다.</br></td>
