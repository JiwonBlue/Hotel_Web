...
<body>
	...
	<div class="roomList" >
		<table class="table">
			...
			<tr>
				<td id="select"><a href="standardroom.do">Standard<button id="next">&#10095;</button></a></td>
			</tr>
			<tr>
		...
		<div class="roomImg">
			<div id="Img">
				<img src="../data/stn1.jpg">
				<img src="../data/stn2.jpg">
				<img src="../data/stn3.jpg">
		...
		<div class="roomInfo">
			<div id="roomContent">
				...
				편안하고 안락한 느낌의 스탠다드룸은 <br />
				고객여러분께 최상의 휴식 환경을 제공합니다.
			</div>
